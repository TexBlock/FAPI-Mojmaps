...
public final class EnchantmentTagGenerator extends FabricTagProvider<Enchantment> {
	...
	protected void addTags(HolderLookup.Provider registries) {
		...
		builder(ConventionalEnchantmentTags.ENTITY_SPEED_ENHANCEMENTS)
				.addOptionalTag(TagKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath("c", "entity_movement_enhancement")));
		builder(ConventionalEnchantmentTags.ENTITY_DEFENSE_ENHANCEMENTS)
				.addOptionalTag(TagKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath("c", "entity_defense_enhancement")));
	}
}
