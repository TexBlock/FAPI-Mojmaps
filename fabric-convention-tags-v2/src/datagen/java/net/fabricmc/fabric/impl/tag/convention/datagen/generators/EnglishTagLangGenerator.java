...
public class EnglishTagLangGenerator extends FabricLanguageProvider {
	public EnglishTagLangGenerator(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
	...
	public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder) {
		...
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE, "Primary Wood Type");
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE_OAK, "Oak Primary Wood Type");
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE_BIRCH, "Birch Primary Wood Type");
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE_SPRUCE, "Spruce Primary Wood Type");
		...
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE_BAMBOO, "Bamboo Primary Wood Type");
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE_CRIMSON, "Crimson Primary Wood Type");
		translationBuilder.add(ConventionalBiomeTags.PRIMARY_WOOD_TYPE_WARPED, "Warped Primary Wood Type");
