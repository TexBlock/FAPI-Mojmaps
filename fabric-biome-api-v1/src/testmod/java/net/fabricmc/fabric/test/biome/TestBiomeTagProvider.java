...
public class TestBiomeTagProvider extends FabricTagProvider<Biome> {
	...
	protected void addTags(HolderLookup.Provider registries) {
		builder(TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(FabricBiomeTest.MOD_ID, "biome_tag_test")))
				.add(TestBiomes.CUSTOM_PLAINS)
				.add(TestBiomes.TEST_END_HIGHLANDS);
		builder(TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(FabricBiomeTest.MOD_ID, "tag_selector_test")))
				.add(Biomes.BEACH)
				.add(Biomes.DESERT)
				.add(Biomes.SAVANNA)
				.add(Biomes.BADLANDS);
