...
public final class FeatureRendererTest implements ClientModInitializer {
	...
	private static class TestPlayerFeatureRenderer extends RenderLayer<PlayerRenderState, PlayerModel> {
		TestPlayerFeatureRenderer(RenderLayerParent<PlayerRenderState, PlayerModel> featureRendererContext) {
