...
public class PillarBlockStateModel implements BlockStateModel {
	...
	public record Unbaked() implements CustomUnbakedBlockStateModel, ModelDebugName {
		private static final List<Material> SPRITES = Stream.of("alone", "bottom", "middle", "top")
				...
				.toList();
		public static final net.fabricmc.fabric.test.renderer.client.PillarBlockStateModel.Unbaked INSTANCE = new net.fabricmc.fabric.test.renderer.client.PillarBlockStateModel.Unbaked();
		public static final MapCodec<net.fabricmc.fabric.test.renderer.client.PillarBlockStateModel.Unbaked> CODEC = MapCodec.unit(INSTANCE);
