...
public class ItemGroupTest implements ModInitializer {
	...
	private static final ResourceKey<Item> ITEM_KEY = ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, "item_test_group"));
	...
	public void onInitialize() {
		Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath("fabric-item-groups-v0-testmod", "item_test_group"), TEST_ITEM);
