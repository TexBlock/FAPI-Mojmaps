...
public class DataGeneratorTestEntrypoint implements DataGeneratorEntrypoint {
	...
	private static class TestBlockTagProvider extends FabricTagProvider.BlockTagProvider {
		...
		protected void addTags(HolderLookup.Provider registries) {
			...
			aliasGroup(ResourceLocation.fromNamespaceAndPath("other_namespace", "flowers"))
					.add(BlockTags.FLOWERS, BlockTags.FLOWER_POTS);
		}
	}
	...
	private static class TestBiomeTagProvider extends FabricTagProvider<Biome> {
		...
		@Override
		protected void addTags(HolderLookup.Provider registries) {
			builder(TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(MOD_ID, "biome_tag_test")))
					.add(Biomes.BADLANDS)
	...
	private static class TestGameEventTagProvider extends FabricTagProvider<GameEvent> {
		...
		@Override
		protected void addTags(HolderLookup.Provider registries) {
			builder(TagKey.create(Registries.GAME_EVENT, ResourceLocation.fromNamespaceAndPath(MOD_ID, "game_event_tag_test")))
