...
public abstract class FabricTagProvider<T> extends TagsProvider<T> {
	...
	public abstract static class ItemTagProvider extends FabricValueLookupTagProvider<Item> {
		 ...
		 * @param output The {@link FabricDataOutput} instance
		 */
		public ItemTagProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture, @Nullable FabricTagProvider.BlockTagProvider blockTagProvider) {
