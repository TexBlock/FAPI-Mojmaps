...
public final class EnumRuleType<E extends Enum<E>> extends GameRules.Type<EnumRule<E>> {
	...
	public EnumRuleType(Function<GameRules.Type<EnumRule<E>>, EnumRule<E>> ruleFactory, BiConsumer<MinecraftServer, EnumRule<E>> changeCallback, E[] supportedValues, GameRules.VisitorCaller<EnumRule<E>> acceptor, Class<EnumRule<E>> enumRuleClass) {
		super(null, ruleFactory, changeCallback, acceptor, enumRuleClass, FeatureFlagSet.of());
	...
	public void register(LiteralArgumentBuilder<CommandSourceStack> literalArgumentBuilder, GameRules.Key<EnumRule<E>> key) {
		LiteralCommandNode<CommandSourceStack> ruleNode = literal(key.getId()).build();
